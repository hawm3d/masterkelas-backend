...
?>
		...
		public function save_bootcamp_toggle_state() {
			if (
				isset($_POST['action'], $_POST['nonce']) && wp_verify_nonce(sanitize_key($_POST['nonce']), 'learndash-bootcamp-toggle') &&
		...
		public function save_bootcamp_mark_complete_state() {
			if (
				isset($_POST['action'], $_POST['nonce']) && wp_verify_nonce(sanitize_key($_POST['nonce']), 'learndash-bootcamp-mark-complete') &&
		...
		private function check_and_update_license() {
			...
			if (($updater) && (is_a($updater, 'nss_plugin_updater_sfwd_lms'))) {
				...
				if (
					false && (isset($_POST['update_nss_plugin_license_sfwd_lms'], $_POST['ld_bootcamp_license_form_nonce']))
