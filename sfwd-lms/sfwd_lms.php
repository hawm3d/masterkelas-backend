<?php
update_option( 'nss_plugin_license_sfwd_lms', 'M6dLYExe-wftT-MFPS-EZgb-xd65bS8D6hrf' );
update_option( 'nss_plugin_license_email_sfwd_lms', 'thisisactivated@learndash.com' );
