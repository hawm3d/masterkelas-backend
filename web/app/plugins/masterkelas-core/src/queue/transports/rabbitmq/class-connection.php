...
class Connection {
  ...
  public function __construct() {
    ...
    if (class_exists('\PhpAmqpLib\Connection\AMQPStreamConnection')) {
      ...
      $rabbitmq_declare_passive_filter    = apply_filters('masterkelas_rabbitmq_declare_passive_filter', false);
      $rabbitmq_declare_durable_filter    = apply_filters('masterkelas_rabbitmq_declare_durable_filter', true);
      $rabbitmq_declare_exclusive_filter  = apply_filters('masterkelas_rabbitmq_declare_exclusive_filter', false);
      $rabbitmq_declare_autodelete_filter = apply_filters('masterkelas_rabbitmq_declare_autodelete_filter', false);
